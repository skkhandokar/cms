...
export default function StaffHome() {
  ...
  useEffect(() => {
    axios.get("https://skkhandokar18.pythonanywhere.com/api/team/chairmen/").then((res) => setChairmen(res.data));
    axios.get("https://skkhandokar18.pythonanywhere.com/api/team/managing-directors/").then((res) => setDirectors(res.data));
    axios.get("https://skkhandokar18.pythonanywhere.com/api/team/staff/").then((res) => setStaff(res.data));
  }, []);
